...
// const htmlPluginEntries = templateFiles.map(() => new HTMLWebpackPlugin({
//   inject: true,
//   hash: false,
//   filename: 'index.html',
...
module.exports = {
  entry: {
    ...
    authorization: ['@babel/polyfill',path.resolve(environment.paths.source, 'js', 'authorization.js')],
    registration: ['@babel/polyfill',path.resolve(environment.paths.source, 'js', 'registration.js')],
  },
  output: {
    filename: 'js/[name].js',
  ...
  plugins: [
    ...
    new HTMLWebpackPlugin({
      ...
      template: path.resolve(environment.paths.source, 'templates', 'registration.html'),
      favicon: path.resolve(environment.paths.source, 'images', 'favicon.png'),
      chunks: ['registration'],
    }),
  ],
